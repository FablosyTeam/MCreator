...
public class FoodStickRightClickedOnBlockProcedure extends FablosyModElements.ModElement {
	public FoodStickRightClickedOnBlockProcedure(FablosyModElements instance) {
		super(instance, 11);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FablosyMod.LOGGER.warn("Failed to load dependency entity for procedure FoodStickRightClickedOnBlock!");
			return;
		}
